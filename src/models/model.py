...
from sqlalchemy import BigInteger, String, Integer, Column, ForeignKey, Table, Numeric, func
...
class Student(db.Model):
    ...
    def fullname(cls):
        ...
        return func.trim('both', func.concat_ws(
            " ",
            cls.firstname,
            func.coalesce(middle, ""),
            cls.lastname
        ))
...
class Grade(db.Model):
    ...
    students_courses = relationship("StudentsCourses", primaryjoin="and_(Grade.id==StudentsCourses.grade_id)", back_populates="grade")
